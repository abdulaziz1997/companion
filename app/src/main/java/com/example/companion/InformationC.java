...
public class InformationC extends AppCompatActivity {

    ImageView iv;
    TextView tv1, tv2;
    int language, city, section, place_id, place, img[], n;
    String name, info;
...
//================= Samarqand ==================
        ...
        iv = (ImageView) findViewById(R.id.ivfon);
        iv.setImageResource(img[place]);

        String select = "id_obyekt = " + String.valueOf(place_id) + " and id_malumot = " + String.valueOf(place_id);

        Cursor friendCursor = database.query("Obyekt, Malumot",
                new String[]
                        {"o_nomi_uz", "o_nomi_eng", "o_nomi_ru", "mal_uz", "mal_eng", "mal_ru"},
            ...
            do {
                ...
                switch(language) {
                    case 0:
                        ...
                        info = friendCursor.getString(3);

                        break;
                    case 1:
                        name = friendCursor.getString(1);
                        info = friendCursor.getString(4);
                        break;
                    case 2:
                        name = friendCursor.getString(2);
                        info = friendCursor.getString(5);
                        break;}
    ...
    public void onMapClick(View view){
        Intent intent = new Intent(InformationC.this, MapsActivity.class);
